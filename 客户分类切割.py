...
rules = {
    ...
    "医院类客户": {
        "keywords": ["医院", "医疗", "中心", "门诊", "诊所", "保健", "疗养", "急救", "卫生院", "医学院", "疾控", "疾病控制", 
                     ...
                     "妇科医院", "专科医院", "肿瘤医院", "眼科", "皮肤科", "精神病院", "检测中心", "研究所"],
    },
    "政府党行政机构类客户": {
        "keywords": ["政府", "局", "委员会", "办公室", "部", "处", "厅", "党", "党委", "机关", "事务局", "管理局", "监察", 
                     "公安", "税务", "海关", "国土", "人民法院", "人民检察院", "行政", "中央", "国家", "地方", "政治", "政法", 
    ...
    "金融银行类客户": {
        "keywords": ["银行", "金融", "投资", "证券", "保险", "信托", "基金", "资产管理", "财务", "支付", "结算", "贷款", 
                     "融资", "信贷", "担保", "信用", "风险", "财产", "货币", "外汇", "分行", "支行", "总行", "营业部", 
                     "网点", "借贷", "小额贷款", "保险经纪", "信贷公司", "小额贷款公司", "财富管理", "国际银行", 
                     "投资银行", "融资租赁"],
    },
    "中字头或国字头企业": {
        "keywords": ["中华", "国家", "中国", "中央", "中共", "国资", "央企", "国企"],
        "regex": r"^(中|国)"
    },
    "交通运输物流仓储类企业": {
